...
@section('content')
    ...
    <div class="container-fluid py-3">
        <div class="">
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="mt-0">
                      <h2 class="position-relative font-23 semi-font fables-blog-category-head fables-main-text-color fables-second-before pl-3 mb-4">MEGAnews</h2> 
                       <div class="row mb-4">
                            @foreach($meganews as $key => $meganewsData)
                                @if($key < 7)
                                <div class="col-3 mb-3">
                                    <a href="#"><img src="{{ asset ($meganewsData->image)}}" alt="" class="img-fluid"></a>
                                </div>
                                <div class="col-3 pl-0 mb-3">
                                    <a href="{{ url('content/'.$meganewsData->id) }}" class="fables-main-text-color bold-font fables-second-hover-color blog-smaller-head">{{ str_limit($meganewsData->title, 40, '...') }}</a>
                                    <p class="fables-forth-text-color font-12" style="margin: 0px">{{ \Carbon\Carbon::parse($meganewsData->created_by)->format('M/d/Y H:i:s') }}</p>
                                </div>
                                @endif
                            @endforeach
                       </div> 
        ...
        <div class="">
            <div class="row">
                <div class="col-12 py-2 col-md-12 ">
                    <div class="text-center mb-5 wow fadeInDown" data-wow-delay="1s" style="visibility: visible; animation-delay: 1s; animation-name: fadeInDown;">
                    <h2 class="fables-second-text-color mt-3 font-30 font-weight-bold text-center">Watch Latest Episodes on Stream!</h2> 
                    <hr style="    width: 8%;
    ...
    <div class="fables-testimonial fables-after-overlay fables-about-caption py-5 bg-rules" style="background-image: url({{ asset ('img/Silhouette-At-Work.jpg')}});">
           <div class="container">
               <div class="row">
                   <div class="position-relative z-index col-12 text-center" > 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="col-12 col-md-12 mb-4 mb-md-0 wow fadeInLeft" data-wow-delay=".3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInLeft;">
                                    <div class="border  fables-second-border-color ">
                                        <div class="row text-center text-lg-left icon-rotate">
                                            ...
                                            <div class="col-12 col-lg-12 text-center text-title">
                            ...
                            <div class="col-md-4">
                                <div class="col-12 col-md-12 mb-4 mb-md-0 wow fadeInLeft" data-wow-delay=".6s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInLeft;">
                                    <div class="border  fables-second-border-color ">
                                        <div class="row text-center text-lg-left icon-rotate">
                                            <div class="col-12 col-lg-12 mb-3 mb-md-0 text-center icon">
                                                <i class="fa-solid fa-photo-film  fables-third-text-color fa-3x"></i>
                                            </div>
                                            <div class="col-12 col-lg-12 text-center">
                                                <a href="/photo-gallery" ><h2 class="fables-third-text-color  fables-second-hover-color font-20 semi-font my-2 mb-lg-3 about-block-heading">Photo Gallery</h2></a>
                            ...
                            <div class="col-md-4">
                                <div class="col-12 col-md-12 mb-4 mb-md-0 wow fadeInLeft" data-wow-delay=".9s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInLeft;">
                                    <div class="border  fables-second-border-color ">
                                        <div class="row text-center text-lg-left icon-rotate">
                                            <div class="col-12 col-lg-12 mb-3 mb-md-0 text-center icon">
                                            ...
                                            <div class="col-12 col-lg-12 text-center">
                                                <h2 class="fables-third-text-color  fables-second-hover-color font-20 semi-font my-2 mb-lg-3 about-block-heading">Holidays</h2>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card" style="box-shadow: 6px 4px 12px; border-radius: 3px;">
                                <div class="col-12 py-2 col-md-12 card-header">
                                    <div class="text-center wow fadeInDown" data-wow-delay="1s" style="visibility: visible; animation-delay: 1s; animation-name: fadeInDown;">
                                        <h2 class="fables-second-text-color font-30 font-weight-bold text-center">Survey</h2> 
                                        <a class="text-secondary font-weight-medium font-11 text-decoration-none" href="/view-all-surveys">View All</a>
                                        <hr  class="mt-0 mb-0"  style="width: 11%;
                                        border: solid 2px gray;">
                                    </div>
                                </div>
                                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card" style="box-shadow: 6px 4px 12px; border-radius: 3px;">
                                <div class="col-12 py-2 col-md-12 card-header">
                                    <div class="text-center wow fadeInDown" data-wow-delay="1s" style="visibility: visible; animation-delay: 1s; animation-name: fadeInDown;">
                                        <h2 class="fables-second-text-color font-30 font-weight-bold text-center">Timeline</h2> 
                                        <a class="text-secondary font-weight-medium font-11 text-decoration-none" href="/view-all-forum">View All</a>
    ...
    <div class="container-fluid py-3" id="communityBoard">
        <div class="card" style="box-shadow: 6px 4px 12px; border-radius: 3px;">
            <div class="col-12 py-2 col-md-12 card-header">
                <div class="text-center wow fadeInDown" data-wow-delay="1s" style="visibility: visible; animation-delay: 1s; animation-name: fadeInDown;">
                    <h2 class="fables-second-text-color mt-3 font-30 font-weight-bold text-center">Community Board</h2> 
                <hr style="width: 11%;
                border: solid 2px gray;">
                </div>
            </div>
            <div class="container-fluid">
                <div class="" style="background-image: linear-gradient(#ffffff, #4c4c4c);">   
                    <div style="overflow:scroll; height:700px;" class="body-flipcard">
                        ...
                        <div class="gallery-filter">
                            ...
                            <div class="portfolioContainer row filter-masonry"> 
                                ...
                                @if ($communityData->image != null)
                                    <div class="image col-12 col-sm-6 col-md-3 mb-2">
                                        <div class="flip">
                                ...
                                @else
                                    <div class="content col-12 col-sm-6 col-md-3 mb-2">
    ...
    <div class="container-fluid py-3" id="blog">
        <div class="card" style="box-shadow: 6px 4px 12px; border-radius: 3px;">
                <div class="col-12 py-2 col-md-12 card-header">
                    <div class="text-center wow fadeInDown" data-wow-delay="1s" style="visibility: visible; animation-delay: 1s; animation-name: fadeInDown;">
                        <h2 class="fables-second-text-color mt-3 font-30 font-weight-bold text-center">Latest Blog</h2> 
                        <a class="text-secondary font-weight-medium font-11 text-decoration-none" href="/view-all-blogs">View All</a>
                ...
                <div class="container-fluid mt-4">
                    <div class="row">   
                        @if(isset($blog))
                            ...
                            @if($key == 0)      
                            <div class="col-12 col-sm-6 col-md-9 mb-4 mb-lg-5"> 
                                <div class="owl-carousel owl-theme default-carousel absolute-dots nav-0">
                                    @foreach($blogData->blog_images as $blog_imageData)
                                    <div class="image-container zoomIn-effect position-relative" style="height: 200px;">
