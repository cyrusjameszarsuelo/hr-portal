    ...
    <div class="container-fluid">
        <div class="container">
            <nav class="breadcrumb bg-transparent m-0 p-0">
                ...
                <a class="breadcrumb-item" href="#">Content</a>
                <span class="breadcrumb-item active">{{ $meganewsSingleContent->content_type->type }}</span>
            </nav>
        </div>
    </div>
    <!-- Breadcrumb End -->
                    ...
                    <div class="position-relative mb-3">
                        ...
                        <div class="overlay position-relative bg-light">
                            <div class="mb-3">
                                ...
                                <span>{{ $meganewsSingleContent->created_at }}</span>
                            </div>
                            <div>
                                <h3 class="mb-3">{{ $meganewsSingleContent->title }}</h3>
                                <p>{{ $meganewsSingleContent->content }}</p>
                            </div>
                        </div>
                    </div>
                    <!-- News Detail End -->
