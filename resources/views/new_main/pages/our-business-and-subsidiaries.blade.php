...
@section('title', 'Our Businesses and Subsidiaries')

@section('page-title', 'Our Businesses and Subsidiaries')
...
@section('content')
	...
	<div class="container pl-5" style="margin-bottom: 12vw">
		...
		<div style="z-index: 5; position: relative;"><a href="/home"><i class="fa fa-home"></i></a> <span> <i class="fa-solid fa-caret-right"></i> <span>Our Businesses and Subsidiaries</span></div>
		...
		<div class="content" style="position: relative; padding-bottom: 10vw;">
			<div class="container">
				...
				<br>
				<div class="row">
					<img src="{{asset('img/our-businesses-and-subsidiaries.png')}}" width="100%" alt="">
				</div>
			</div>
